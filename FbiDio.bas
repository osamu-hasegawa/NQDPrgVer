...
'///   TBK/TE   ///
'   /TBK/
If tbkte = "tbk" Then DioOut 12, 0 '   '位置制御=0 (tsubaki): 080320
If tbkte = "tbk" Then DioOut 13, 1 '   '速度上限設定（内部設定へ切り替え）tsubaki
'///////////////////////////////////////////////////////////
'   /TE/
If tbkte = "te" Then DioOut 12, 1 '    '位置制御　　東栄　　080827
'/////////////////////////////////////////////////////////////
End Sub
Public Sub CtlVelo()
Dim disp!
...
'///   TBK/TE   ///
'   /TBK/
If tbkte = "tbk" Then DioOut 12, 1 '    '速度制御=1:  08.3.20 tsubaki
If tbkte = "tbk" Then DioOut 13, 0 '    '速度上限設定（外部設定へ切り替え）tsubaki
'///////////////////////////////////////////////////////////
'   /TE/
If tbkte = "te" Then DioOut 12, 0  '    '速度制御　　東栄　080827
'///////////////////////////////////////////////////////////
  disp = r_z()
End Sub
Public Sub N2Open()
